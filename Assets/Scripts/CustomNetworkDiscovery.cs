...
namespace UnityEngine.Networking
{
	...
	public class CustomNetworkDiscovery : MonoBehaviour
	{
		...
		void Start() {
			server = GetComponent<CustomNetworkManagerHUD> ().server;
			Initialize ();
		}
		...
		public bool StartAsClient()
		{
			...
			m_Running = true;
			m_IsClient = true;
			if (LogFilter.logInfo || LogFilter.logError) { Debug.Log("StartAsClient Discovery listening"); }
			return true;
		}
		...
		public bool StartAsServer()
		{
			...
			m_Running = true;
			m_IsServer = true;
			if (LogFilter.logInfo || LogFilter.logDebug) { Debug.Log("StartAsServer Discovery broadcasting"); }
